...
#### 다중 카메라 테스트
```
uvicorn fastapi_server:app --host 0.0.0.0 --port 8041
streamlit run streamlit_app.py -- --server_url http://192.168.10.96:8041
python webcam_client.py --camera front:0 --server http://192.168.10.96:8041
python webcam_client.py --camera side:0 --server http://192.168.10.96:8041
```
