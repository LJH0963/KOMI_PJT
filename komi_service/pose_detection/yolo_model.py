...
class YoloPoseModel:
    ...
    def detect_pose(self, image, conf_threshold=0.5) -> dict:
        """
        이미지에서 포즈 감지 수행
    ...
    def draw_pose(self, image: np.ndarray, pose_data: dict, draw_skeleton: bool = True, draw_keypoints: bool = True) -> np.ndarray:
        """
        감지된 포즈를 이미지에 시각화
    ...
    def process_base64_image(self, base64_image: str) -> np.ndarray:
        """
        Base64 인코딩된 이미지 처리
